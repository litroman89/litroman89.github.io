...
<head>
    ...
    <title>Privacy Policy Oursupport</title>
    ...
    <link rel="stylesheet" href="/styles/policy.min.css">
</head>
...
<div class="container">
    ...
    <div class="container">
        ...
        <h5 data-localization="hero-date"></h5>
        <p data-localization="hero-description"></p>
    </div>
</section>
        <div class="section policy-text">
    <div class="container">
        <h5 data-localization="text-date"></h5>
        <p data-localization="text-summary">
        </p>

        <h3 data-localization="text-introduction"></h3>

        <p data-localization="text-introductionDescription">
        </p>


        <h3 data-localization="text-overview"></h3>

        <h3 data-localization="text-scope"></h3>
        <p data-localization="text-overviewDescription">
        </p>


        <h3 data-localization="text-dataController"></h3>

        <p data-localization="text-dataControllerDescription">
        </p>


        <h3 data-localization="text-data"></h3>

        <h3 data-localization="text-data_a"></h3>
        <p data-localization="text-data_a_Description">
        </p>

        <h3 data-localization="text-data_b"></h3>
        <p data-localization="text-data_b_Description">
        </p>

        <h3 data-localization="text-data_c"></h3>
        <p data-localization="text-data_c_Description">
        </p>


        <h3 data-localization="text-data_d"></h3>
        <p data-localization="text-data_d_Description">
        </p>

        <h3 data-localization="text-data_e"></h3>
        <p data-localization="text-data_e_Description">
        </p>



        <h3 data-localization="text-choice"></h3>
        <p data-localization="text-choiceDescription">
        </p>

        <h3 data-localization="text-choice_a"></h3>

        <p data-localization="text-choice_a_Description">
        </p>

        <h3 data-localization="text-choice_b"></h3>

        <p data-localization="text-choice_b_Description">
        </p>

        <h3 data-localization="text-choice_c"></h3>

        <p data-localization="text-choice_c_Description">
        </p>


        <h3 data-localization="text-updates"></h3>
