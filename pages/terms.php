...
<head>
    ...
    <title>Terms of use Oursupport</title>
    ...
    <link rel="stylesheet" href="/styles/terms.min.css">
</head>
...
<div class="container">
    ...
    <div class="container">
        <br /><br />
        <p data-localization="text-start">
        </p>

        <h3 data-localization="text-acceptanceTitle"></h3>

        <p data-localization="text-acceptanceDescription">
        </p>

        <h3 data-localization="text-deliveryTitle"></h3>

        <p data-localization="text-deliveryDescription">
        </p>

        <h3 data-localization="text-respTitle"></h3>

        <p data-localization="text-respDescription">
        </p>

        <h3 data-localization="text-chargesTitle"></h3>

        <p data-localization="text-chargesDescription">
        </p>

        <h3 data-localization="text-paymentsTitle"></h3>

        <p data-localization="text-paymentsDescription">
        </p>

        <h3 data-localization="text-salesTitle"></h3>

        <p data-localization="text-salesDescription">
        </p>

        <h3 data-localization="text-cancellationTitle"></h3>

        <p data-localization="text-cancellationDescription">
        </p>

        <h3 data-localization="text-substitutionTitle"></h3>

        <p data-localization="text-substitutionDescription">
        </p>

        <h3 data-localization="text-disputeTitle"></h3>

        <p data-localization="text-disputeDescription">
        </p>

        <h3 data-localization="text-modsTitle"></h3>

        <p data-localization="text-modsDescription">
        </p>

        <h3 data-localization="text-indemTitle"></h3>

        <p data-localization="text-indemDescription">
        </p>

        <h3 data-localization="text-confidentialityTitle"></h3>

        <p data-localization="text-confidentialityDescription">
        </p>

        <h3 data-localization="text-terminationTitle"></h3>

        <p data-localization="text-terminationDescription">
        </p>

        <h3 data-localization="text-contractTitle"></h3>

        <p data-localization="text-contractDescription">
        </p>
    </div>
</section>
        <footer class="footer">
