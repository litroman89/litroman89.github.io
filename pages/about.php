...
<div class="container">
    ...
    <div class="container">
        <div class="about-mission__text">
            <h2><span data-animate="first-title" data-localization="mission-title"></span></h2>
            <p>
                <span data-animate="subtitle" data-localization="mission-description"></span>
            </p>
        </div>

        <div class="about-mission__wrapper">
            <div data-animate="card-up" class="about-mission__wrapper__block">
                <img src="../img/support/card4.svg" alt="card one">

                <h3 data-localization="mission-card1Title"></h3>
                <p data-localization="mission-card1Description"></p>
            </div>

            <div data-animate="card-up" class="about-mission__wrapper__block">
                <img src="../img/support/card2.svg" alt="card two">

                <h3 data-localization="mission-card2Title"></h3>
                <p data-localization="mission-card2Description"></p>
            </div>

            <div data-animate="card-up" class="about-mission__wrapper__block">
                <img src="../img/support/card3.svg" alt="card three">

                <h3 data-localization="mission-card3Title"></h3>
                <p data-localization="mission-card3Description"></p>
            </div>

            <div data-animate="card-up" class="about-mission__wrapper__block">
                <img src="../img/support/card1.svg" alt="card four">

                <h3 data-localization="mission-card4Title"></h3>
                <p data-localization="mission-card4Description"></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <h2><span data-animate="title" data-localization="values-title"></span></h2>

        <div class="about-values__wrapper">
            <hr>

            <div data-animate="slide-right-left" class="about-values__wrapper__block">
                <div class="about-values__wrapper__block__name">
                    <h4>01</h4>
                    <h3 data-localization="values-value1"></h3>
                </div>

                <div data-localization="values-value1Description" class="about-values__wrapper__block__descr"></div>
            </div>
            ...
            <div data-animate="slide-right-left" class="about-values__wrapper__block">
                <div class="about-values__wrapper__block__name">
                    <h4>02</h4>
                    <h3 data-localization="values-value2"></h3>
                </div>

                <div data-localization="values-value2Description" class="about-values__wrapper__block__descr"></div>
            </div>
            ...
            <div data-animate="slide-right-left" class="about-values__wrapper__block">
                <div class="about-values__wrapper__block__name">
                    <h4>03</h4>
                    <h3 data-localization="values-value3"></h3>
                </div>

                <div data-localization="values-value3Description" class="about-values__wrapper__block__descr"></div>
            </div>
            ...
            <div data-animate="slide-right-left" class="about-values__wrapper__block">
                <div class="about-values__wrapper__block__name">
                    <h4>04</h4>
                    <h3 data-localization="values-value4"></h3>
                </div>

                <div data-localization="values-value4Description" class="about-values__wrapper__block__descr"></div>
            </div>
            ...
            <div data-animate="slide-right-left" class="about-values__wrapper__block">
                <div class="about-values__wrapper__block__name">
                    <h4>05</h4>
                    <h3 data-localization="values-value5"></h3>
                </div>

                <div data-localization="values-value5Description" class="about-values__wrapper__block__descr"></div>
            </div>
            ...
            <div data-animate="slide-right-left" class="about-values__wrapper__block">
                <div class="about-values__wrapper__block__name">
                    <h4>06</h4>
                    <h3 data-localization="values-value6"></h3>
                </div>

                <div data-localization="values-value6Description" class="about-values__wrapper__block__descr"></div>
            </div>
    ...
    <div class="container">
        <div class="about-community__wrapper">
            <div class="about-community__wrapper__descr">
                <h4 data-localization="community-title"></h4>

                <h2><span data-animate="title" data-localization="community-descriptionTitle"></span></h2>
                <p>
                    <span data-animate="subtitle" data-localization="community-description"></span>
                </p>

                <a href="http://portal.oursupport.co" class="portal" target="_blank">
                    <div data-localization="community-button" class="portal__left"></div>
            ...
            <picture>
                <source srcset="../img/about-community/gathering.webp" type="image/webp"">
                <img src=" ../img/about-community/gathering.jpg" alt="background image" loading="lazy">
            </picture>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="about-support__wrapper">
            <h2><span data-animate="title" data-localization="support-title"></span></h2>
            <p>
                <span data-animate="subtitle" data-localization="support-description"></span>
            </p>
        </div>

        <a href="http://portal.oursupport.co" target="_blank" class="imageLink">
            <img src="../img/about-support/smile.jpg" alt="image" loading="lazy">
        </a>
        <div class="advocate__linksWrapper">
            <p class="advocate__linksWrapper__title" data-localization="links-title"></p>
            <p class="advocate__linksWrapper__descr" data-localization="links-description"></p>
