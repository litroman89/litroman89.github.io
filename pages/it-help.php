...
<head>
    ...
    <title>IT-Help Oursupport</title>
    ...
    <link rel="stylesheet" href="/styles/itHelp.min.css">
</head>
...
<div class="container">
    ...
    <section class="it-help">
    <div class="container">
        <div class="it-help__wrapper">
            <picture>
                <source srcset="/img/it-help/iPhone.jpg" media="(min-width: 1100px)" />
                <source srcset="/img/it-help/iPhone-mobile.jpg" media="(max-width: 1100px)" />
                <img src="/img/it-help/iPhone.jpg" alt="phone">
            </picture>
            <div class="it-help__wrapper__content">
                <h2 data-localization="title"></h2>
                <p data-localization="description">At OurSupport, we understand that technology everyone’s comfort area,
                    which can lead to frustration
                    when seeking help.</p>

                <div class="qr-code-wrapper">
                    <img src="/img/it-help/qr-code.svg" alt="QR code">
                    <img src="/img/it-help/qrCode-text.png" alt="scan QR code">

                </div>
                <div class="it-help__wrapper__content__links">
                    <a href="https://apps.apple.com/be/app/oursupport/id1506321441" target="_blank"
                        class="it-help__wrapper__content__links__link app">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.tsolnetworks.oursupport" target="_blank"
                        class="it-help__wrapper__content__links__link google">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 46" fill="none">
                            <rect width="160" height="46" rx="23" fill="#040829" />
                            <path
                            ...
                            <path
                                ...
                                fill="white" stroke="white" stroke-width="0.16" stroke-miterlimit="10" />
                            <path
                                d="M68.595 16.513H67.9029V11.9128H66.4033V11.2688H70.0958V11.9128H68.595V16.513V16.513Z"
                                fill="white" stroke="white" stroke-width="0.16" stroke-miterlimit="10" />
