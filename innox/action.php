...
$mail->setFrom('info@info.com','info info');
 ...
 $mail->addAddress('famat39517@dogemn.com');
...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['message'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;"> Повідомлення чи питання:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['message'] . '</b></td></tr>';
    }
    //
